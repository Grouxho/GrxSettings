...
public abstract class SublimeBaseMenuItem implements Parcelable {
    ...
    SublimeBaseMenuItem(SublimeMenu menu, int group, int id,
        ...
        //String id_opcion= mMenu.getContext().getResources().getResourceEntryName(id);
       // int i = mMenu.getContext().getResources().getIdentifier(id_opcion,"xml",mMenu.getContext().getPackageName());
       // if (i!=0 ){
       //     mGrxPantalla = id_opcion;
       // } else mGrxPantalla = "";
    ...
    public SublimeBaseMenuItem pon_pantalla(int id){
    ...
    private Bundle saveState() {
       ...
       // bundle.putString(SS_PANTALLA,mGrxPantalla);
        ...
        switch (itemType) {
            ...
            case BADGE:
                ...
                return SublimeTextWithBadgeMenuItem.createFromBundle(bundle, groupId, id, title,
                    hint, iconResId, valueProvidedAsync, showsIconSpace, flags);
                //SublimeTextWithBadgeMenuItem m = SublimeTextWithBadgeMenuItem.createFromBundle(bundle, groupId, id, title,
                        //hint, iconResId, valueProvidedAsync, showsIconSpace, flags);
                //return m.pon_pantalla(id);
            ...
            default:
                ...
                //SublimeTextMenuItem mm = new SublimeTextMenuItem(groupId, id, title,
                        //hint, iconResId, valueProvidedAsync, showsIconSpace, flags);
                //return mm.pon_pantalla(id);
        }
    }
}
